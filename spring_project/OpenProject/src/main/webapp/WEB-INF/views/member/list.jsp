...
<body>
	...
	<main role="main" class="container-fluid">
				...
				<table class="border">
					...
					<c:forEach items="${memberList}" var="member">
						<tr>
							...
							<td><a class="border" href="edit?idx=${member.idx}">수정</a> <a
								class="border" href="delete?idx=${member.idx}">삭제</a></td>
						</tr>
					</c:forEach>
				</table>
		...
		<div class="my-3 p-3 bg-white rounded shadow-sm">test</div>
	</main>
