...
import member.sevice.ChangePasswordService;
import member.sevice.MemberRegService;
...
//		MemberRegService service = new MemberRegService(new MemberDao());
		...
		if(request.isPasswordEqualToConfirmPassword()) {
			System.out.println("비밀번호와 비밀번호 확인 일치하지 않습니다.");
			return;
		}
	...
	static void printMenu() {
		...
		System.out.println("new 이멜 이름 비밀번호 비밀번호확인");
