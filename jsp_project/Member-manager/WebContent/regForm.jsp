	...
	$.(document).ready(function(){
		...
		$('#memberid').focusout(fuction(){
			...
			$.ajax({
				...
				beforeSend : function(){
					$('#lodingimg').removeClass('display_none')
				},
				success : function(){
					// data : y / n
					if(data == 'y'){
				...
				error : function(request, status, error){
					alert('서버 통신 문제가 발생했습니다. 다시 실행해주세요.')
					console.log(request);
					console.log(status);
					console.log(error);
				},
		...
		<form action="memberReg.jsp" method="post" enctype="multipart/form-data"> 
			<table>
				<tr>
					...
					<img id="lodingimg" class="display_none" alt="Loading" src="<c:url value="/img/loading.gif"/>"> 
					</td>
				</tr>
				<tr>
					<td>비밀번호</td>
